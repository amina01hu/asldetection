    ...
    if results.multi_hand_landmarks:
        ...
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            if is_thumbs_up(img, hand_landmarks.landmark, mp_hands):
                ...
                cv2.putText(img, 'Not Thumbs Up!', (50, 50), cv2.FONT_HERSHEY_PLAIN, 1, (0, 0, 0), 2)

            if asl_alphabet(hand_landmarks) != 0:
                 cv2.putText(img, 'Letter ' + asl_alphabet(hand_landmarks), (50, 300), cv2.FONT_HERSHEY_PLAIN, 1, (0, 0, 0), 2)
